                                    ...
                                    <div className="space-y-3">
                                        ...
                                        {(driverAssignment?.pickup_proof_url || driverAssignment?.delivery_proof_url) && (
                                            <div className="mt-2 pt-2 border-t border-amber-200/50">
                                                <p className="text-xs font-medium text-amber-800 mb-2">Dokazi vozača:</p>
                                                <div className="flex gap-2">
                                                    {driverAssignment.pickup_proof_url && (
                                                        <a
                                                            href={driverAssignment.pickup_proof_url}
                                                            target="_blank"
                                                            rel="noopener noreferrer"
                                                            className="block relative group w-16 h-16 rounded-lg overflow-hidden border border-amber-200 hover:border-amber-400 transition-colors"
                                                        >
                                                            ...
                                                            <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors flex items-center justify-center">
                                                                <div className="bg-white/90 p-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity">
                                                                    <Image size={10} className="text-amber-600" />
                                                                </div>
                                                            </div>
                                                        </a>
                                                    )}
                                                    {driverAssignment.delivery_proof_url && (
                                                        <a
                                                            href={driverAssignment.delivery_proof_url}
                                                            target="_blank"
                                                            rel="noopener noreferrer"
                                                            className="block relative group w-16 h-16 rounded-lg overflow-hidden border border-amber-200 hover:border-amber-400 transition-colors"
                                                        >
